...
x_train_bi, x_test_bi, x_val_bi, y_train_bi, y_test_bi, y_val_bi = f.feature_extraction_sm(c.training_set, c.testing_set, c.val_set, True)
x_train_hax, x_test_hax, x_val_hex, y_train_hax, y_test_hax, y_val_hex = f.feature_extraction_sm(c.training_set, c.testing_set, c.val_set, False)
...
def decision_tree():
    ...
    # cm.confusion_matrix(y_test_bi, y_predict_bi, c.bidirectional_labels, "Decision Tree Confusion Matrix | 2-Ways (SM)")
    # cm.confusion_matrix(y_test_hax, y_predict_hex, c.labels, "Decision Tree Confusion Matrix | 6-Ways (SM)")
...
def logistic_regression():
    ...
    # cm.confusion_matrix(y_test_bi, y_predict_bi, c.bidirectional_labels, "Logistic Regression Confusion Matrix | 2-Ways (SM)")
    # cm.confusion_matrix(y_test_hax, y_predict_hax, c.labels, "Logistic Regression Confusion Matrix | 6-Ways (SM)")
    t2 = time.time()
...
def support_vector_machine():
    ...
    # cm.confusion_matrix(y_test_bi, y_predict_bi, c.bidirectional_labels, "SVM Confusion Matrix | 2-Ways (SM)")
    # cm.confusion_matrix(y_test_bi, y_predict_bi, c.labels, "SVM Confusion Matrix | 6-Ways (SM)")
...
def kNN(k_size=3):
    ...
    # cm.confusion_matrix(y_test_bi, y_predict_bi, c.bidirectional_labels, "kNN Confusion Matrix | 2-Ways (SM)")
    # cm.confusion_matrix(y_test_hax, y_test_hax, c.labels, "kNN Confusion Matrix | 6-Ways (SM)")
    t2 = time.time()
