...
x_train_bi, x_test_bi, x_val_bi, y_train_bi, y_test_bi, y_val_bi = f.feature_extraction_s(c.training_set, c.testing_set, c.val_set, True)
x_train_hax, x_test_hax, x_val_hex, y_train_hax, y_test_hax, y_val_hex = f.feature_extraction_s(c.training_set, c.testing_set, c.val_set, False)
...
def kNN(k_size=3):
    ...
    e.eva_nnn(y_test_hax, y_predict_hax, y_test_bi, y_predict_bi, f"K-Nearest Neighbor, k={k_size}: ")
    cv.validate(model_bi, model_hax, x_val_bi, y_val_bi, y_val_hex)
