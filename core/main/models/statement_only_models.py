...
x_train_bi, x_test_bi, y_train_bi, y_test_bi = f.feature_extraction(c.training_set, True, 0.5)
x_train_hax, x_test_hax, y_train_hax, y_test_hax = f.feature_extraction(c.training_set, False, 0.5)
