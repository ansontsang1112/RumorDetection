...
x_train_bi, x_test_bi, y_train_bi, y_test_bi = f.feature_extraction_s(c.training_set, c.testing_set, True)
x_train_hax, x_test_hax, y_train_hax, y_test_hax = f.feature_extraction_s(c.training_set, c.testing_set, False)
