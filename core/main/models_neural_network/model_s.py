...
def lstm(in_dim):
    ...
    model.fit(x_train, y_train_bi, validation_data=(x_test, y_test_bi), epochs=5, batch_size=64)
    model_hex.fit(x_train, y_train_hex, validation_data=(x_test, y_test_hex), epochs=5, batch_size=64)
