...
training_set = pd.read_csv("../../../files/core/preprocessed/training_set_preprocessed.csv")
testing_set = pd.read_csv("../../../files/core/preprocessed/training_set_preprocessed.csv")
